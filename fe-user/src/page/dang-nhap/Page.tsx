          ...
          <div className="mx-auto grid max-w-screen-xl gap-8 lg:grid-cols-2">
            ...
            <div className="relative hidden overflow-hidden rounded-lg bg-green-600 lg:block">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-white">
                <h2 className="mb-6 text-3xl font-bold">Chào mừng trở lại!</h2>
                <p className="mb-8 text-center text-lg">
                  Đăng nhập để tiếp tục hành trình xây dựng hồ sơ chuyên nghiệp và tìm kiếm cơ hội việc làm lý tưởng.
                </p>
                <div className="mb-8 space-y-4">
                  {[
                    "Truy cập và cập nhật CV của bạn bất cứ lúc nào",
                    "Ứng tuyển công việc chỉ với một cú nhấp chuột",
                    "Nhận đề xuất việc làm phù hợp với kỹ năng của bạn",
            ...
            <div className="mx-auto flex max-w-md flex-col justify-center space-y-6 p-4 md:p-8">
              <div className="text-center lg:text-left">
                ...
                <p className="mt-2 text-gray-500">Nhập thông tin của bạn để đăng nhập vào tài khoản</p>
              </div>
              ...
              <div className="mt-4 text-center text-sm lg:hidden">
                ...
                <Link to="/dang-ky" className="font-medium text-green-600 hover:underline">
                  Đăng ký ngay
                </Link>
              </div>
            </div>
