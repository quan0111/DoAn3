    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <Select
            ...
            onValueChange={(value: string) => updateFormData("level", value)}
          >
            <SelectTrigger className="mt-2">
      ...
      <div>
        ...
        <Select
          ...
          onValueChange={(value: string) => updateFormData("workType", value)}
        >
          <SelectTrigger className="mt-2">
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <RadioGroup
          ...
          onValueChange={(value: string) => updateFormData("salaryType", value)}
          className="mt-2"
        >
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <div className="space-y-2 text-sm">
          ...
          <p>
            ...
            {formData.locations.join(", ") || "Chưa chọn"}
          </p>
          <p>
            ...
            {formData.salaryType === "negotiable"
              ? "Thỏa thuận"
              : formData.salaryType === "upto"
              ? `Lên đến ${formData.salaryMax} ${formData.currency}`
    ...
    switch (currentStep) {
      ...
      case 2:
        return (
          ...
          (formData.salaryType === "negotiable" || formData.salaryMax)
        );
      case 3:
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <CardHeader>
        <CardTitle className="flex items-center space-x-2">
          {(() => {
            const Icon = steps[currentStep - 1].icon; // Gán icon vào biến in hoa
